    ...
    <Container id="portfolio">
      ...
      <ScrollAnimation animateIn="flipInX">
        <div className="project">
          ...
          <div className="body">
            <h3>Card Title</h3>
            <p>Uma aplicação Web realizada durante o Hackathon do programa de formação daLorem ipsum is placeholder text commonly  <a href="#"> ABC here</a>. used in the graphic, print, and publishing industries for previewing layouts and visual mockups.
            </p>
          </div>
          <footer>
